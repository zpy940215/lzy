	...
	var editList = {
		...
		getProdPrices: function() {
			...
			$.ajax({
				...
				data: {
					...
					//"prodPriceVo.beginTime":'2018-01-01',
		...
		save: function() {
			$("#producteditsubmit").click(function() {
				...
				editList.areaId = $('#rootAreaId').val();
				...
				for (var i = 0; i < prodPrices.length; i++) {
					...
					postData['prodPriceVoList[' + i + '].param1Name'] = prodPrices[i].param1Name;
					postData['prodPriceVoList[' + i + '].param1Value'] = prodPrices[i].param1Value;
					postData['prodPriceVoList[' + i + '].param2Name'] = prodPrices[i].param2Name;
					postData['prodPriceVoList[' + i + '].param2Value'] = prodPrices[i].param2Value;
					postData['prodPriceVoList[' + i + '].param3Name'] = prodPrices[i].param3Name;
					postData['prodPriceVoList[' + i + '].param3Value'] = prodPrices[i].param3Value;
					
					postData['prodPriceVoList[' + i + '].beginTime'] = "2017-12-22";
					postData['prodPriceVoList[' + i + '].endTime'] = "2019-12-22";
				}
