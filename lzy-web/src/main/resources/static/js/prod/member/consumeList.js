...
function($, common, jqueryui, Handlebars, HandlebarExt, moment, stay) {
	var member = {
		...
		memberList: function() {
			...
			postData['logUserScoreConsumeVo.startDate'] = $('.js_register_startDate').val();
			postData['logUserScoreConsumeVo.endDate'] = $('.js_register_endDate').val();
			postData['logUserScoreConsumeVo.uid'] = member.uid;
			$.ajax({
				url: '${base}/member!userScoreConsumeList.ajax',
				data: postData,
				dataType: 'json',
				beforeSend: function () {
