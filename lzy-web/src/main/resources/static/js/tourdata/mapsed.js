...
*/
	...
	(function () {
		...
		var DEFAULT_CENTER = new google.maps.LatLng(22.536113, 22.536113);
		var DEFAULT_ZOOM = 6;
		...
		var _plugIn = this,           // Reference back to the "mapsed" plug-in instance
				...
				_areBoundsSet = true,    // Used to flag that an event has set the boundary (so we don't set the zoom/center manually as GM will calc this for us)
		...
		function getViewTemplate() {
			...
			var html =
			  ...
			  +"<div class='mapsed-button'><input type='button' value='确定'></div>"
		...
		function getEditTemplate() {
			var html =
				...
				+ "<li>"
				+ "<label>名称：</label>"
				+ "<input class='mapsed-name' type='text' placeholder='请输入名称！' value='{NAME}' />"
				+ "</li>"
				+ "<li>"
				+ "<label>地址：</label>"
				+ "<input class='mapsed-street' type='text' placeholder='请输入地址！' value='{STREET}' />"
				+ "</li>"

				+ "<li>"
				+ "<label>电话：</label>"
				+ "<input class='mapsed-telNo' type='telephone' placeholder='请输入电话！' value='{TELNO}' />"
				+ "</li>"
