...
public class ExcelUtil {
	...
	public static long floatToLong(Float money) {
		if(money == null) {
			return 0L;
		}
		return new BigDecimal(String.valueOf(money)).multiply(new BigDecimal(100F)).longValue();
	}
	...
	public static long doubleToLong(Double money) {
		...
		return new BigDecimal(String.valueOf(money)).multiply(new BigDecimal(100D)).longValue();
	}
	
	public static long yuanToFen(BigDecimal money) {
		if(money == null) {
			return 0L;
		}
		return money.multiply(new BigDecimal(100D)).longValue();
	}
	...
	private static class Processer{
		...
		private void setCellValue(HSSFCell hssfCell, Cell cell) {
			...
			if (key.equals(Data.INT)) {
				...
				if (value != null) {
					hssfCell.setCellValue(Double.valueOf((Long)value) * 0.01d);
				} else {
